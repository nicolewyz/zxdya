 ...
 * 
 */
public class TVPageProcessor implements PageProcessor{
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new TVPageProcessor()).addUrl("http://www.ygdy8.net/plus/sitemap.html")
        //.setScheduler(new QueueScheduler().setDuplicateRemover(new BloomFilterDuplicateRemover(1000000)) )
        .setScheduler(new FileCacheQueueScheduler("c:/data/webmagic/tv"))
        .thread(5).run();
