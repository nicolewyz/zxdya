...
public class YgdyPageProcessor implements PageProcessor{
    ...
    public void process(Page page) {
        ...
        if(page.getUrl().regex("http://www\\.ygdy8\\.net/plus/sitemap\\.html").match()){
            page.addTargetRequests(page.getHtml().xpath("//table[@bgcolor='#CEDD9B']//").links().regex(".*/html/gndy/.*").all());
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new YgdyPageProcessor()).addUrl("http://www.ygdy8.net/plus/sitemap.html")
