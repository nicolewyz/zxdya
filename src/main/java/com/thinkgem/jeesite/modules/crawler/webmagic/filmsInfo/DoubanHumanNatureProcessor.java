 ...
 *
 */
public class DoubanHumanNatureProcessor implements PageProcessor{
    ...
    public void process(Page page) {
        ...
        if(page.getUrl().regex("https://www\\.douban\\.com/doulist/4250734/\\?start=\\d+&sort=seq&sub_type=").match()){
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new DoubanHumanNatureProcessor()).addUrl(
        		"https://www.douban.com/doulist/4250734/?start=0&sort=seq&sub_type=")
        .thread(1).run();
