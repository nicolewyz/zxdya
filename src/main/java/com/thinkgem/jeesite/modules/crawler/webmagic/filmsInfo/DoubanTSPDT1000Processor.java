 ...
 *
 */
public class DoubanTSPDT1000Processor implements PageProcessor{
    ...
    public void process(Page page) {
        ...
        //1. 如果是用户列表页面 【入口页面】，将所有用户的详细页面的url放入target集合中。
    							https://www.douban.com/doulist/44366354/?start=0&sort=time&sub_type=
        if(page.getUrl().regex("https://www\\.douban\\.com/doulist/44366354/\\?start=\\d+&sort=time&sub_type=").match()){
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new DoubanTSPDT1000Processor()).addUrl(
        		"https://www.douban.com/doulist/44366354/?start=0&sort=time&sub_type=")
        .thread(1).run();
