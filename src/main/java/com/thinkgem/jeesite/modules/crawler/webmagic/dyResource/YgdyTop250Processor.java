 ...
 * 
 */
public class YgdyTop250Processor implements PageProcessor{
    ...
    public void process(Page page) {
        ...
        if(page.getUrl().regex("http://www\\.ygdy8\\.net/html/gndy/jddy/20160320/50510.html").match()
        		|| page.getUrl().regex("http://www\\.ygdy8\\.net/html/gndy/jddy/20160320/50510_\\d+.html").match()){
            page.addTargetRequests(page.getHtml().xpath("//center").links().regex(".*/html/gndy/.*/[\\d]{8}/50510_\\d+.*").all());
            page.addTargetRequests(page.getHtml().xpath("//div[@class='co_content8']/ul").links().regex(".*/html/gndy/.*/[\\d]{8}/.*").all());
            
        //2. 如果是用户详细页面
        }else if(page.getUrl().regex("http://www\\.ygdy8\\.com/html/gndy/[\\w]+/\\d{8}/\\d+\\.html").match()){
...
//        Spider.create(new YgdyTop250Processor()).addUrl("http://www.ygdy8.net/index.html" )
//        .thread(1).run();
...
//	}
    ...
    public static void main(String[] args) {
        long startTime ,endTime;
        System.out.println("=====www.ygdy8.net  top 250===电影信息首页小爬虫【启动】喽！=========");
        startTime = new Date().getTime();
        Spider.create(new YgdyTop250Processor()).addUrl("http://www.ygdy8.net/html/gndy/jddy/20160320/50510.html" )
        .thread(1).run();
        endTime = new Date().getTime();
        System.out.println("=====www.ygdy8.net  top 250===电影首页小爬虫【结束】喽！=========");
